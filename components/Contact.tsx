            ...
            <AnimatePresence mode="wait">
              {formStatus === 'success' ? (
                <motion.div 
                  ...
                  className="py-20 md:py-32 flex flex-col items-center justify-center bg-white border border-black/5 rounded-[2rem] md:rounded-[4rem]"
                >
                ...
                <motion.form 
                  ...
                  className="space-y-12 sm:space-y-14 md:space-y-16 relative"
                >
                  ...
                  <AnimatePresence>
                    {formStatus === 'sending' && (
                      <motion.div 
                        ...
                        animate={{ opacity: 1 }}
                        exit={{ opacity: 0 }}
                        className="absolute inset-0 z-50 flex flex-col items-center justify-center bg-[#F9F8F6]/80 backdrop-blur-sm rounded-3xl"
                      >
                        <div className="w-10 h-px bg-black/10 relative overflow-hidden mb-6">
                          <motion.div 
                            ...
                            className="absolute inset-y-0 left-0 bg-black w-full origin-left"
                          ></motion.div>
                        </div>
                    ...
                    <AnimatePresence>
                      {insight && (
                        <motion.div 
                          ...
                          exit={{ opacity: 0, y: 20 }}
                          transition={{ duration: 0.8, ease: [0.16, 1, 0.3, 1] }}
                          className="mt-8 p-6 md:p-10 bg-[#0A0A0A] text-white rounded-[1.5rem] md:rounded-[2.5rem]"
                        >
                  ...
                  <button type="submit" className="group flex items-center gap-6 md:gap-8 outline-none pt-4">
                    <motion.div 
                      ...
                      whileTap={{ scale: 0.95 }}
                      className="w-12 h-12 md:w-14 lg:w-18 md:h-14 lg:h-18 rounded-full flex items-center justify-center transition-all duration-1000 bg-black shadow-lg shrink-0"
                    >
